...
<div>
	<a href="#"><img src="${banner}" height="300" width="500"
		...
		<security:authorize access="hasRole('BROTHERHOOD')">
			<li><a class="fNiv"><spring:message
				...
				<ul>
					...
					<li><a href="actor/brotherhood/edit.do"><spring:message
								code="master.page.brotherhood.edit" /></a></li>
				</ul></li>
		</security:authorize>

		<security:authorize access="hasRole('MEMBER')">
			<li><a class="fNiv"><spring:message code="master.page.r" /></a>
				<ul>
					<li class="arrow"></li>
					...
					<li><a href="actor/member/edit.do"><spring:message
								code="master.page.member.edit" /></a></li>
				</ul></li>
		</security:authorize>
			...
			<li><a class="fNiv"><spring:message
				...
				<ul>
					...
					<li><a href="brotherhood/create.do"><spring:message
								code="master.page.brotherhood.create" /></a></li>
